<?php
  ...
  function guardarImagen($filename) {
    ...
    //$id = $usuario['id'];
      ...
      if ($ext != 'jpg' && $ext != 'png' && $ext != 'jpeg') {
        $errores['avatar'] = 'La imagen debe ser formato .jpg o .png';
        return $errores;
      }

  		$path = $_SERVER['DOCUMENT_ROOT'] . "/images/avatars/$filename.$ext";
  ...
  function loguear($datos)
  {
      ...
      if (isset($datos['recordarme'])) {
          setcookie("email", $usuario['email'], time() + 60 * 60 * 24 * 365 * 5);
      }
  }
